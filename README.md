...
Labelled IP addresses with analysis on the possible anomaly types. 
*The IP addresses and network traffic traces we investigated are from the MAWI Archive (https://mawi.wide.ad.jp/mawi/)
